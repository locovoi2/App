package edu.ub.pis.app.view.ui.trainer_daily_routines.pages;
...
import edu.ub.pis.app.view.TrainerHomeActivity;
import edu.ub.pis.app.view.UserCardAdapter;
import edu.ub.pis.app.view.ui.trainer_daily_routines.DailyRoutineCardAdapter;
import edu.ub.pis.app.view.ui.trainer_daily_routines.ExerciceCompletedCardAdapter;
...
public class DailyPage extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TrainerHomeActivity activity = (TrainerHomeActivity)getActivity();
        TextView addButton = rootView.findViewById(R.id.addButton);
        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DailyRoutineCardAdapter popupAdapter = new DailyRoutineCardAdapter(totalRoutines, day, mUserCardRVAdapter, thisPage, activity.getUserMail());
