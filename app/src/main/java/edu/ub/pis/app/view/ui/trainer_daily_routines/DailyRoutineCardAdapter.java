package edu.ub.pis.app.view.ui.trainer_daily_routines;
...
import edu.ub.pis.app.view.ui.trainer_daily_routines.pages.DailyPage;
...
public class DailyRoutineCardAdapter extends RecyclerView.Adapter<DailyRoutineCardAdapter.ViewHolder> {
    ...
    public DailyRoutineCardAdapter(ArrayList<Routine> dataSet, int day, UserCardAdapter userCardAdapter, DailyPage parent, String userMail) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int p) {
        ...
        holder.addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                updateFirestoreArray(userMail, day, cardData, true, null);
            }
        });
        holder.removeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                updateFirestoreArray(userMail, day, cardData, false, newExercises);
            }
        });
